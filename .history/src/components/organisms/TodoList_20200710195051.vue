        ...
        <v-app-bar-nav-icon></v-app-bar-nav-icon>
            <v-toolbar-title>Todo List</v-toolbar-title>
              ...
              <v-dialog v-model="dialog">
                ...
                <todo-form @close="dialogClose()" :key="formCount" @getData="getData" @update="updateTodo"></todo-form>
              </v-dialog>
...
async selected(todo: any) {
  ...
  console.log('selentedTodo', selectedTodo);
  this.$emit('update', selectedTodo);
}
